...
main:							$(OBJDIR)/main.o $(OBJDIR)/ququ_filter.o $(OBJDIR)/shuffle_matrix_512.o $(OBJDIR)/shuffle_matrix_512_16.o $(OBJDIR)/shuffle_matrix_512_16_2.o
...
$(OBJDIR)/shuffle_matrix_512_16_2.o: 	$(LOC_SRC)/shuffle_matrix_512_16_2.c
